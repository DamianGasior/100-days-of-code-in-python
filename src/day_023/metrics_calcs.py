...
class Underlying_metrics:
    def __init__(self,underlying_request:Underlying_request_details,underlying_df:Underlying_data_frame):
        ...
        print('drugi obiekty klasy "Underlying_metrics" ',type(self.underlying_df))
    ...
    def worst_and_best(self):
        ...
        worst_idx = self.underlying_df['return'].idxmin()
        best_idx  = self.underlying_df['return'].idxmax()
        ...
        worst_val = self.underlying_df.loc[worst_idx, 'return']
        best_val  = self.underlying_df.loc[best_idx, 'return']
